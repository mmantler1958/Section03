...
function addNumbersFrom1Too100() {
  let total = 0;
  for (let i = 1; i <= 100; i++) {
    total += i;
  }
...
console.log(addNumbersFrom1Too100());
// try to print the variable "total" outside the function
// ? what do you expect ?
//console.log(total); //Errors out
...
function parentAndChildScope() {
  ...
  console.log('Parent Scope, Child Variable:', childVariable); //will not print due to scope
}
parentAndChildScope();
